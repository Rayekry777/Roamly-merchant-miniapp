...
Page({
  data: {
    code: "",
    loading: false,
    preview: null as RedemptionPreview | null,
    error: "",
  },
  onShow() {
  ...
  async confirm() {
    ...
    try {
      await confirmRedemption(this.data.preview.previewToken);
      this.setData({ preview: null, code: "" });
